...
jsPsych.plugins['free-sort'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div '+
      ...
      'style="  background-image: url(../static/img/blue.png); background-repeat: no-repeat;   background-size: cover; position: relative;  width:'+ trial.sort_area_width+'px; height:'+trial.sort_area_height+'px;  border:2px solid #444;"' + 
